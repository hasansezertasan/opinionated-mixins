...
- Extend Scope:
  - Form Validation: WTForms, Django Forms, Pydantic, etc.
  - Data Validation: Marshmallow, Pydantic, etc.
  - Serialization: Marshmallow, Pydantic, etc.
  - Data Containers: Pydantic, dataclasses, etc.
